...
const DEFAULTS := {
	"exec_assistant": {
		...
		"dialogue_tip_refusal": "Not enough yet.",
	...
	"journalist": {
		...
		"dialogue_tip_refusal": "You're not getting anything yet.",
	...
	"trading_bro": {
		...
		"dialogue_tip_refusal": "Come back when I'm feeling it.",
	...
	"ceo": {
		...
		"dialogue_tip_refusal": "You haven't earned that.",
